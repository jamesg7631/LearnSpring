package com.in28minutes.learn_spring_framewok.helloworld;
...
public class HelloWorldConfiguration {
    ...
    @Bean
    @Primary
    // No qualifying bean of tpe 'com.in28minutes.learnspringframework.Address'
    ...
    public Address address() {
        return new Address("121 Nethergreen Crescent", "Glasgow");
    }
